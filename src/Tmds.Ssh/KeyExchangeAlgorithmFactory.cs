...
sealed class KeyExchangeAlgorithmFactory
{
    ...
    public KeyExchangeAlgorithmFactory()
    {
        ...
        _algorithms.Add(AlgorithmNames.Curve25519Sha256, name => new Curve25519Sha256KeyExchange());
        _algorithms.Add(AlgorithmNames.Curve25519Sha256LibSsh, name => new Curve25519Sha256KeyExchange());
        ...
        _algorithms.Add(AlgorithmNames.MLKem768X25519Sha256, name => new MLKem768X25519Sha256KeyExchange());
    }
